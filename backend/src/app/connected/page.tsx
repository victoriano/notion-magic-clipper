export default function ConnectedPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
	...
	return (
		<main style={{ padding: 24, fontFamily: 'system-ui, sans-serif' }}>
			...
			{workspaceId ? (
				<p style={{ color: '#666' }}>Workspace ID: <code>{workspaceId}</code></p>
			) : null}
