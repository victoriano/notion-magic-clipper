...
export async function GET(req: NextRequest) {
  ...
  async function getAccountInfo(token: string | null) {
    if (!token)
      return { account_email: null as string | null, account_name: null as string | null };
    try {
